...
function HomeScreen({ history }) {
  ...
  return (
    <div>
      {!keyword && (
        <>
          <div style={{ fontWeight: "bold", fontSize: "24px", color: "black", fontFamily: "" }}>Best Deals</div>
          <ProductCarousel />
        </>
      )}

      <div style={{ fontWeight: "bold", fontSize: "24px", color: "black", fontFamily: "" }}>Today's Deals</div>
      {loading ? (
        <Loader />
      ) : error ? (
